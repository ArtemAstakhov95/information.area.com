...
$table = new Tables('pages', 'Сторінки', 'code', 'year_start', Page::$db);
...
$subTable->addField('concept_id','lookup','Поняття',false,true,true);
$subTable->addLookupField('concept_id','Concepts','id','concept');

$subTable->parseUrl();
echo $subTable->handle();
